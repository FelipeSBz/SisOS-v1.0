		...
		<?php echo "<p>ATENDIMENTO Nº $idConsulta</p>"; ?>
			...
			<table width="100%">
				...
				<tr>
					...
					<?php echo "<td width='90%' bgcolor='#CCCCCC'><textarea name='realizado' rows='5' cols='59' required>$realizado</textarea>"; ?></td>
				</tr>
			</table>
			...
			<table width="100%">
				<tr>
					...
					<td width="40%" bgcolor="#003366"><div align="center"><input type="button" value="Imprimir" onClick="window.print()"/></div></td>
