...
<body>
	...
	<form method="POST" action="../../sys/os/inserir_os.php">
		<div align="center">
			<table width="100%">
				<tr>
...
value='Lista de Ramais'></td>						
				...
				<tr>			
					...
					<td bgcolor="#02679C"><div align="center">
						<font face="Arial, Helvetica, sans-serif" size="2" color="#FFFFFF">Identificação:</font></div></td>
					<td bgcolor="#CCCCCC">
						<input type="text" size="42" name="patrimonio" maxlength="60" value="" placeholder="Patrimonio, Série ou MAC" required></td>
				...
				<tr>
					...
					<td bgcolor="#CCCCCC">
						<input name="situacao" list="situacao" required>
			...
			<table width="100%">
				...
				<tr>
					...
					<td width="90%" bgcolor="#CCCCCC">
						<textarea name="constatado" rows="5" cols="59"></textarea></td>
				</tr>
				<tr>
					<td width="10%" bgcolor="#02679C"><div align="center"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">
